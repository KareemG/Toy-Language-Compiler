...
public class CodeGen extends ASTVisitor.Default {
	...
	private void ir_operation_helper(short operation, IR.Operand lhs, IR.Operand rhs)
	{
		...
		System.out.println("ir operation - " + this.result_stack.size());
	}
	...
	void Initialize() {
		...
		actions.put(42, (s, self) -> {
			...
			System.out.println("BRANCH ON FALSE - " + this.result_stack.size());
		});
		...
		actions.put(71, (s, self) -> {
			...
			System.out.println("less than operation - " + this.result_stack.size());
		});
		...
		actions.put(76, (s, self) -> {
			...
			System.out.println("obtain variable - " + this.result_stack.size());
		});
		...
		actions.put(77, (s, self) -> {
			...
			System.out.println("STORE - " + this.result_stack.size());
		});
		...
		actions.put(78, (s, self) -> {
			...
			System.out.println("push false - " + this.result_stack.size());
		});
		...
		actions.put(79, (s, self) -> {
			...
			System.out.println("push true - " + this.result_stack.size());
		});
		...
		actions.put(80, (s, self) -> {
			...
			System.out.println("integer constant - " + this.result_stack.size());
		});
		...
		actions.put(90, (s, self) -> {
			System.out.println("Stack size = " + this.result_stack.size());
