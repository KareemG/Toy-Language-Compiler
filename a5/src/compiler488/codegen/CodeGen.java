...
public class CodeGen extends ASTVisitor.Default
{
	...
	void Initialize() {
		...
		actions.put(42, (s, self) -> {
			this.intermediate_code.add(new IR(IR.BF, new IR.Operand(IR.Operand.REGISTER, this.result_stack.pop().shortValue()), new IR.Operand(IR.Operand.PATCH_FALSE, (short) 0)));
		});
